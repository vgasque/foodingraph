...
#' \code{\link{boot_simulated_cat_bin}}, such that it simulates independent associations
#' between ordinal-ordinal, binary-binary and ordinal-binary pairs of variables.
#' It calculates the CI bootstraps for each paiwise association of the variables'
...
#' sure the structure corresponds). \bold{2.} the legend (described above).
